...
* replace fscanf() with fgets()+sscanf()
***********************************************/
...
int main(int argc, char **argv)
{
	...
	char tmp_buf[128];
	//char tmp_str[128];//store lines from fgets(), a line should be less than 60 chars
	...
	*****************************************************************/
	...
	for(loop_file=1;loop_file<=max_file_idx;loop_file++)
	{
		...
		else
		{
			...
			{
				sscanf(tmp_buf,"%d %d %lf %d %d %d %d %d %d %lf %d\n",&ray_i,&ray_j,&dis,&P_celltype,&P_cellname,&P_chlname,&P_vacuolename,&P_tri,&P_outin_P,&tmp_I,&ray_status);
