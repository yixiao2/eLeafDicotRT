...
model.component('comp1').geom('geom1').feature(tmptag_blk).set('pos', {'0' '0' '-EPL_l_thick*1.5'});
...
for loop_i=1:N_EPL_rows
    for loop_j=1:N_EPL_cols
...
model.component('comp1').geom('geom1').feature(tmptag_blk).set('size', {'PAL_box_length' 'PAL_box_length' 'EPL_u_thick*1.5'});
...
%% PAL CHL
load('tmp_PAL_CHL_distribute.mat', 'PAL_CHL_center_final_pts')
...
tmptag_spo=['dif',num2str(count_dif)];count_dif=count_dif+1;
model.component('comp1').geom('geom1').create(tmptag_spo, 'Difference');
%count_dif=count_dif+1;
model.component('comp1').geom('geom1').feature(tmptag_spo).selection('input').set(GLB_tag_SPO_blk);
model.component('comp1').geom('geom1').feature(tmptag_spo).selection('input2').set(GLB_tag_SPO_MS);
...
%% SPO CHL
load('tmp_SPO_CHL_distribute.mat', 'SPO_CHL_center_final_pts')
